...
then
	echo "*********************** Upgrading setup - setup:upgrade ****************************" 
	 php -d memory_limit=-1 /var/www/html/magento/bin/magento setup:upgrade
	...
	php -d memory_limit=-1 /var/www/html/magento/bin/magento setup:static-content:deploy -f
	echo "*********************** Permission ***********************************************"
fi
