...
echo "Configuring Redis page cache: /var/www/html/bin/magento setup:config:set --page-cache=redis ${redis_fpc_args[@]}"
/var/www/html/bin/magento setup:config:set --page-cache=redis "${redis_fpc_args[@]}"
